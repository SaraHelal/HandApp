                        ...
                        <div class="card teamFollow my-5">
                            <form method="POST" action="">
                                <div class="card-header">
                                    <h3 class="card-title font-weight-bold">Daily Follow Up (Teams)</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                                    ...
                                                    <td>
                                                        <div class="form-group mt-2">
                                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                                <input type="checkbox" class="custom-control-input" id="customSwitch00{{$i}}">
                                                                <label class="custom-control-label" for="customSwitch00{{$i}}"></label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group mt-2">
                                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                                <input type="checkbox" class="custom-control-input" id="customSwitch0{{$i}}">
                                                                <label class="custom-control-label" for="customSwitch0{{$i}}"></label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group mt-2">
                                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                                ...
                                                                <label class="custom-control-label" for="customSwitch2{{$i}}"></label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group mt-2">
                                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                                <input type="checkbox" class="custom-control-input" id="customSwitch3{{$i}}">
                                                                <label class="custom-control-label" for="customSwitch3{{$i}}"></label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group mt-2">
                                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                                <input type="checkbox" class="custom-control-input" id="customSwitch4{{$i}}">
                                                                <label class="custom-control-label" for="customSwitch4{{$i}}"></label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
